		 ...
		 <ul class="megamenu skyblue">
			 <li class="active grid"><a class="color1" href="<?php echo base_url("home")?>">Home</a></li>
			  ...
			  <li class="grid"><a class="color2" href="<?php echo base_url("user/product/select_fertilizer")?>"><b>fertilizers</b></a>
				...
				<li class="grid"><a class="color4" href="<?php echo base_url("user/product/select_tools")?>"><b>Agro Tools</b></a>
				<div class="megapanel">
					<div class="row">
                    <?php
					...
					?>
						<div class="col1">
							<div class="h_nav">
								 <a href="<?php echo base_url('user/product/view_tools_type_detail/'.$tools_type_data[$j]->tools_type_id);?>"><h4><?php echo $tools_type_data[$j]->tools_type_name; ?></h4>
                                 </a>
								<ul>
                                <?php
								...
								?>
									<li>
                                    <a href="<?php  echo base_url('user/product/view_tools_subtype_detail/'.$tools_subtype_data[$i]->tools_subtype_id);?>"><h5><b><?php echo $tools_subtype_data[$i]->tools_subtype_name; ?></b></h5>	</a>
                           		    </li>
                                <?php
									}
								}
				...
				<li class="grid"><a class="color4" href="<?php echo base_url("user/product/select_pesticide")?>"><b>Agro pesticide</b></a>
				<div class="megapanel">
					<div class="row">
                    <?php
					...
					?>
						<div class="col1">
							<div class="h_nav">
								<a href="<?php echo base_url('user/product/view_pesticide_type_detail/'.$pesticide_type_data[$j]->pesticide_type_id);?>"><h4><?php echo $pesticide_type_data[$j]->pesticide_type_name; ?></h4>
                                 </a><ul>
                                <?php
								...
								?>
									<li>
                                    <a href="<?php  echo base_url('user/product/view_pesticide_subtype_detail/'.$pesticide_subtype_data[$i]->pesticide_subtype_id);?>"><h5><b><?php echo $pesticide_subtype_data[$i]->pesticide_subtype_name; ?></b></h5>	</a>
                           		    </li>
                                <?php
									}
								}
			   ...
			   <div class="search">
				 <form action="<?php echo base_url() ?>home/parts">
					<input type="text" value="" name="place" placeholder="Search..." class="biginput" id="autocomplete" style="padding:10px;margin-bottom:-10px;width:250px;height:45px">
