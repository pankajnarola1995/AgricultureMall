             ...
             <tr>
				...
				<form id="registration_form" action="<?php echo base_url("user/product/book_order")?>" method="post">
                 <td style="width:650px">
					<div class="textBox noIconLeft cardDropDown"><input type="text" name="cardnumber" maxlength="19" placeholder="XXXX-XXXX-XXXX-XXXX" ><img src="<?php echo base_url("data/images")?>/card.png" style="float:right;margin-top:-34px;margin-right:-60px">
                     ...
                     <br>
					 <div class="textBox noIconLeft upperCase"><input type="text" name="name" placeholder="ENTER NAME ON THE CARD"><img src="<?php echo base_url("data/images")?>/cardname.png" style="float:right;margin-top:-35px;margin-right:-60px"></i></div>								
					<div>
						<label>
