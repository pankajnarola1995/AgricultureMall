         ...
         <div class="container">
				 <tr>		
					   ...
					   <div class="cart-item-info">
                            ...
                            <h4> <b><lable ><?php echo $_SESSION['cart'][$i]['qty'];?></label></b><h4>
                             </td>
                             <td>
							...
							//echo strtotime('+7 days',date("Y-m-d"));
							 ...
							 $_SESSION['cart'][$i]['subtotal']=$subtot;
							 echo $subtot;
             ...
             <?php 
					...
					?>
                           ...
                           <?php   $_SESSION["payment"]="cash"; ?> 
                             	<td style="text-align:right"><a class="order" style="" href="<?php  echo base_url("user/product/book_order")?>">CASH PAYMENT</a><a class="order" style="" href="<?php  echo base_url("user/product/payment")?>">NET BANKING PAYMENT</a>
                               </td>
                               <td colspan="4" style="text-align:right;font-size:28px" ><b>AMOUNT PAYABLE :</b><br><span><span class="fa fa-rupee"></span><?php  echo $_SESSION['price'] ?></span></span>
                               </td>
                           </tr>
                               </div>
                           </table>
