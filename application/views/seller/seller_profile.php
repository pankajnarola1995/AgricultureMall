...
<br>		 <p style='font-size:20px' align='center'><strong>".$this->session->flashdata("edit_profile")."</strong> </p>
</div>";
?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form name="imgfrm"  action="<?php echo base_url("seller/seller/seller_profile_update_seller") ?>" method="post"  enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-user-information">
                    <tbody>
                      ...
                      <tr>
						...
						{
							if(trim($city["city_id"])==trim($seller_data[0]["city"]))
							echo $city["city_name"];
						}?></td>
                      </tr>
                      <tr>
                        <td>Gender</td>
                        <td><?php echo $seller_data[0]["gender"]?></td>
                      </tr>
                   
                         <tr>
                             <tr>
                        <td>Company Name</td>
                        <td><?php echo $seller_data[0]["company_name"]?></td>
                      </tr>
                        <tr>
                        <td>Home Address</td>
                        <td><?php echo $seller_data[0]["address"]?></td>
                      </tr>
                      <tr>
                        <td>Mobile Number</td>
                 ...
                 <div class="panel-footer">
                       <a href="<?php echo base_url("seller/seller/seller_updateprofile");?>" title="Edit this user" data-toggle="tooltip" type="button" class="btn btn-primary"><i class="menu-icon icon-edit"></i></a>
