...
echo "<div class='alert alert-error' id='regimsg' style='position:absolute;width:100%;height:42px;'>
					...
					<div class="content" >
						...
						<div class="module">
							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" method="post" action="<?php echo base_url('seller/seller/seller_security_question');?>" enctype="multipart/form-data">	
                                 ...
                                 <div class="control-group" align="center">
											<div class="controls" >
												<button type="submit" class="btn btn-primary pull-right"  name="register" id="register" >Verify</button>
											</div>
										</div>
									</form>
							</div>
