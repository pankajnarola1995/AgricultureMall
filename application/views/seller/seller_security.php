					...
					<div class="content" >
						...
						<div class="module">
							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" method="post" action="<?php echo base_url("seller/seller/seller_newpassword")?>" enctype="multipart/form-data">	
                                    
                          <input type="hidden" name="security_q" id="security_q" class="span8" value="<?php  echo $question;?>">
                                    
                                    <div class="control-group">
											<label class="control-label" ><b>Your Question</b></label>
											<div class="controls">
                                            <label class="control-label" id="security_question" name="security_question"><b><?php  echo $question;?></b></label>
                               			...
                               			<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="security_answer" id="security_answer" placeholder="Type Your Answer" class="span8">
                                 ...
                                 <div class="control-group" align="center">
											<div class="controls" >
												<button type="submit" class="btn btn-primary pull-center"  name="register" id="register" >Confirm Queation</button>
											</div>
										</div>
									</form>
							</div>
