	...
	$("document").ready(function(){
		...
		$("#send").click(function(){
			...
			else
			{
				...
				<div class="span9">
					<div class="content" >
							 <form method="post" name="deletemsg" action="<?php echo base_url("seller/seller/seller_delete_message")?>" >
					<div class="module message">
                                ...
                                <div class="module-option clearfix">
                                    ...
                                    <div class="pull-right">
                                        <a href="#sendmessage" class="btn btn-primary" data-toggle="modal">Compose</a>
                                    </div>
                                        ...
                                        <tbody>
                                            <tr class="heading">
                                             ...
                                             <?php
												...
												{
													foreach($seller_message as $data)
													{?>
                                            ...
                                            <tr class="unread">
                                                ...
                                                <td class="cell-title">
                                                  <a href="<?php echo base_url()?>seller/seller/seller_message/<?php echo $data['chat_id']?>"> <?php echo $data["subject"] ?></a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <select  data-placeholder="Select here" name="seller_id" id="seller_id" style="width:300px">
                                        ...
                                        <option value="Bha7871">ADMIN</option>
										 <?php
												//$data="";		
													foreach($seller_msg as $data)
													{
														if($data['seller_id']==$this->session->userdata("seller_login_id"))
														{
														}
														else
														{
