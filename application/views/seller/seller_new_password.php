					...
					<div class="content" >
						...
						<div class="module">
							...
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" method="post" action="<?php echo base_url("seller/seller/newpassword")?>" >	
                                ...
                                <div class="control-group" align="center">
											<div class="controls"  >
                                              ...
                                              <button type="submit" class="btn btn-primary pull-center"  name="register" id="register"   >Save New Password</button>
											</div>
										</div>
									</form>
							</div>
