			...
			else
			{
				...
				<div class="span9">
					<div class="content" style="margin-left:30px">
							 <form method="post" name="deletemsg" action="<?php echo base_url("admin/admin/admin_delete_trash_message")?>" >
                                        ...
                                        <div class="btn-group">
                                           <a href="<?php echo base_url("admin/admin/admin_inbox") ?>" class="btn" style="background-color:#CCC" >Inbox</a>
                                            ...
                                            <ul class="dropdown-menu">
                                             ...
                                             <input type="submit" name="backmsg" id="backmsg" value="Back Up" class="btn"style="margin-left:10px">
