			...
			else
			{
				...
				<div class="span9">
					<div class="content" style="margin-left:30px" >
							 <form method="post" name="deletemsg" action="<?php echo base_url("admin/admin/admin_send_delete_message")?>" >
                                        ...
                                        <div class="btn-group">
                                           <a href="<?php echo base_url("admin/admin/admin_inbox") ?>" class="btn" style="background-color:#CCC">Inbox</a>
                                            ...
                                            <ul class="dropdown-menu">
                                             ...
                                             <input type="submit" name="deletemsg" id="deletemsg" value="Delete"  class="btn" style="padding-left:10px;margin-left:50px">
                                    ...
                                    <table class="table table-message" style="font-family:'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif;font-size:14px">
                                        <tbody>
                                            ...
                                            <tr class="unread">
                                                ...
                                                <td class="cell-title">
                                                  <a href="<?php echo base_url()?>admin/admin/admin_message/<?php echo $data['chat_id']?>">   <?php echo $data["subject"] ?></a>
                                                </td>
                                                <td class="cell-icon hidden-phone hidden-tablet">
