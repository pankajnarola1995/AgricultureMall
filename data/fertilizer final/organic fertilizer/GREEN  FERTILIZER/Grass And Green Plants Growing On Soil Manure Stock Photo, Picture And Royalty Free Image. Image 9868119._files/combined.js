...
//  var newXCoordinate = targetObjectId.x + xOffset + ((document.body.scrollLeft)?document.body.scrollLeft:0);
//  var newYCoordinate = targetObjectId.y + yOffset + ((document.body.scrollTop)?document.body.scrollTop:0);
...
function adv_search_ver2()
{
    ...
    /*
    	if(readCookie('advsearchdisplay_new')=='none')
	{
		toggle_advancedsearch2009('bsc_search');
        return false;
	}
...
function setCookie(name, value, expires, path, domain, secure)
{
	...
	var cookie_dom = domain.substr(3);
	if (domain == 'www.123rf.hk')
	{
		//alert(cookie_dom);
	}
