...
resizeData['object2053555356'] = {
   responsive: [
                  { left: 0.88, top: 0.24, visible: true }, 
                  { left: 0.81, top: 0.4, visible: true }, 
                  { left: 0.84, top: 0.42, visible: true }, 
                  { left: 0.88, top: 0.24, visible: false }, 
                  { left: 0.88, top: 0.24, visible: false }, 
               ],
   area: {
       x: -2.59,
...
resizeData['object1389390792'] = {
   responsive: [
                  { left: 0.5, top: 0.5, visible: false }, 
                  { left: 0.5, top: 0.5, visible: false }, 
                  { left: 0.78, top: 0.48, visible: false }, 
                  { left: 0.96, top: 0.17, visible: true }, 
                  { left: 0.96, top: 0.29, visible: false }, 
               ],
   area: {
       x: -1.59,
       y: -1.59
...
resizeData['textblock-1323236578'] = {
   responsive: [
                  { left: 0.97, top: 0.23, visible: true }, 
                  { left: 0.96, top: 0.24, visible: true }, 
                  { left: 0.96, top: 0.36, visible: true }, 
                  { left: 0.81, top: 0.89, visible: true }, 
                  { left: 0.72, top: 0.84, visible: true }, 
               ],
   area: {
       x: 0,
       y: 0
...
resizeData['textblock-462999024'] = {
   responsive: [
                  ...
                  { left: 0.9, top: 0.89, visible: true }, 
                  { left: 0.84, top: 0.84, visible: true }, 
               ],
   area: {
       x: 0,
       y: 0
...
resizeData['textblock-195548152'] = {
   responsive: [
                  ...
                  { left: 0.97, top: 0.84, visible: true }, 
               ],
   area: {
       x: 0,
       y: 0
...
jQuery(function ($) {
    ...
    processElementMultiplyBg(".art-header", {
        ...
        "bgposition": "0 0",
        "images": "url('images/object335476396.png'),url('images/object1609977350.png'),url('images/object1754510630.png'),url('images/object1441477670.png'),url('images/object463750045.png'),url('images/object854693039.png'),url('images/object2053555356.png'),url('images/object1389390792.png'), ",
        "positions": "0px 31px,0px 42px,405px 36px,31px 13px,10px 12px,458px 38px,634px 9px,442px 30px, "
    });
});
if (typeof window.resizeData === 'undefined') window.resizeData = {};
