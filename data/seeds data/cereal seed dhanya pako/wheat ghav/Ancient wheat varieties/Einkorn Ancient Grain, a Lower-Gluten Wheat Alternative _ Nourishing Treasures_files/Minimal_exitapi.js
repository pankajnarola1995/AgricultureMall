...
MinimalAd.prototype.setProducts = function(products) {
  ...
  var productsNumber = Math.min(products.length, productElements.length);
  this.productsContainer.classList.add('products-number-' + productsNumber);
  for (var i = 0, length = productsNumber; i < length; i++) {
...
/**
 * Function create object that contains product parameters and functions to
 * handle click and rollover events.
